        ...
        <>
            ...
            <div className="flex flex-col items-center justify-center py-20 h-full">
                ...
                <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                    <h1 className="text-4xl md:text-6xl lg:textxl md:!leading-snug font-semibold text-center text-blue-700">
                        Master AWS Amplify
                    </h1>
                    <p className="text-base md:text-xl text-foreground/80 mt-6 text-center">
                        Deploy applications, authenticate users, manage data, and optimize development environments.
                    </p>
